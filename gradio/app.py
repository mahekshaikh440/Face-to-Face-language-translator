...
final_language = gr.inputs.Dropdown([ "Russian","Italian","Spanish","German","English","Japanese","Hindi"])
...
gr.Interface(fn = video_to_translate,
           ...
           examples = [
            ...
            ).launch(auth = [('user','admin'),('Alex','Alex25')], auth_message = "Check your login details sent to your email")  
